...
export default function AddEditTaskModal({
  ...
  return (
    ...
    >
      <div className="modal">
        <h3>{type === "edit" ? "Modifier" : "Ajouter une"} tâche</h3>
        <label htmlFor="task-name-input">Titre de la tâche</label>
        ...
        <div className="description-container">
          <textarea
            ...
            placeholder="ex : C'est toujours bon de faire une pause. Cette pause de 15 minutes va recharger les batteries un peu."
          />
        </div>
        ...
        >
          {type === "edit" ? "Sauvegarder" : "Créer la tâche"}
        </button>
      </div>
    </div>
  );
